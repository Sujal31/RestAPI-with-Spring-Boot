...
public class StreetDirection {
    ...
    public StreetDirection withChangeFlagSpecified(Boolean changeFlagSpecified) {
        this.changeFlagSpecified = changeFlagSpecified;
        return this;
    }
    ...
    public StreetDirection withValue(Object value) {
        this.value = value;
        return this;
    }
    ...
    public StreetDirection withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StreetDirection) == false) {
            return false;
        }
        StreetDirection rhs = ((StreetDirection) other);
