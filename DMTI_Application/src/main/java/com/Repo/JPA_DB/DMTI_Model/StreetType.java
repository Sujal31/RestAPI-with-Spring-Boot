...
public class StreetType {
    ...
    public StreetType withChangeFlagSpecified(Boolean changeFlagSpecified) {
        this.changeFlagSpecified = changeFlagSpecified;
        return this;
    }
    ...
    public StreetType withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public StreetType withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StreetType) == false) {
            return false;
        }
        StreetType rhs = ((StreetType) other);
