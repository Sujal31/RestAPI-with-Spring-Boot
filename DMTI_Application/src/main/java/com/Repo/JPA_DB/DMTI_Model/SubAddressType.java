...
public class SubAddressType {
    ...
    public SubAddressType withChangeFlagSpecified(Boolean changeFlagSpecified) {
        this.changeFlagSpecified = changeFlagSpecified;
        return this;
    }
    ...
    public SubAddressType withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public SubAddressType withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SubAddressType) == false) {
            return false;
        }
        SubAddressType rhs = ((SubAddressType) other);
