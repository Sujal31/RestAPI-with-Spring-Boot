...
public class StreetPreType {
    ...
    public StreetPreType withChangeFlagSpecified(Boolean changeFlagSpecified) {
        this.changeFlagSpecified = changeFlagSpecified;
        return this;
    }
    ...
    public StreetPreType withValue(Object value) {
        this.value = value;
        return this;
    }
    ...
    public StreetPreType withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StreetPreType) == false) {
            return false;
        }
        StreetPreType rhs = ((StreetPreType) other);
