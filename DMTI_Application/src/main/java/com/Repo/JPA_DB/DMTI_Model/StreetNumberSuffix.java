...
public class StreetNumberSuffix {
    ...
    public StreetNumberSuffix withChangeFlagSpecified(Boolean changeFlagSpecified) {
        this.changeFlagSpecified = changeFlagSpecified;
        return this;
    }
    ...
    public StreetNumberSuffix withValue(Object value) {
        this.value = value;
        return this;
    }
    ...
    public StreetNumberSuffix withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StreetNumberSuffix) == false) {
            return false;
        }
        StreetNumberSuffix rhs = ((StreetNumberSuffix) other);
