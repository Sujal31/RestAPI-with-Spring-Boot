...
public class StreetName {
    ...
    public StreetName withChangeFlagSpecified(Boolean changeFlagSpecified) {
        this.changeFlagSpecified = changeFlagSpecified;
        return this;
    }
    ...
    public StreetName withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public StreetName withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StreetName) == false) {
            return false;
        }
        StreetName rhs = ((StreetName) other);
