...
public class PostalMunicipality {
    ...
    public PostalMunicipality withChangeFlagSpecified(Boolean changeFlagSpecified) {
        this.changeFlagSpecified = changeFlagSpecified;
        return this;
    }
    ...
    public PostalMunicipality withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public PostalMunicipality withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PostalMunicipality) == false) {
            return false;
        }
        PostalMunicipality rhs = ((PostalMunicipality) other);
