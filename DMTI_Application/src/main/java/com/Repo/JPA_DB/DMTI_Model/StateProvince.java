...
public class StateProvince {
    ...
    public StateProvince withChangeFlagSpecified(Boolean changeFlagSpecified) {
        this.changeFlagSpecified = changeFlagSpecified;
        return this;
    }
    ...
    public StateProvince withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public StateProvince withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StateProvince) == false) {
            return false;
        }
        StateProvince rhs = ((StateProvince) other);
